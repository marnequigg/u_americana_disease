...
#here you have two options: you can either run the script with ./align_samples.sh or you can use the script 01b.execute_alignment.sh to run multiple samples at once
